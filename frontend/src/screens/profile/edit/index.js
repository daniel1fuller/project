        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.fieldsContainer}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate('editProfileField', { title: 'Name', field: 'name', value: auth.currentUser.name })}>
                    <Text>Name</Text>
                ...
                <TouchableOpacity
                style={buttonStyles.grayOutlinedButtonLogout}
                onPress={() => onLogout()}
            >
                <Text style={buttonStyles.grayOutlinedButtonText}>Logout</Text>
            </TouchableOpacity>
