...
import { getFeed, getImageFeed, getImageFeedTwo, getPostsByUserId } from '../../services/posts'
 ...
 */
export default function FeedScreen({ route,item }) {
...
console.log(user)
    ...
    return (
        <SafeAreaView style={styles.container}>
            <PopHeader />
            <ScrollView>
            <FeedFeedPostListHorizontal posts={posts}/>
            <FeedPostList user={user} posts={posts}/>
            </ScrollView>
        </SafeAreaView>
    )
}
