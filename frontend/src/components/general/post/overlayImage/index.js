...
export default function PostSingleOverlayImage({ user, post, item }) {
...
<View style={styles.container}>
  ...
  <Text style={styles.descriptionBoxText}>{post.caption?post.caption:post.description}</Text>
  </View>
...
<View style={styles.popIconBox}>
  ...
  >
    ...
    <Image style={styles.shareIcon} source={require('frontend/assets/whiteShare.png')}/>
    </View>
    <Text style={styles.popIconText}>
      {post.commentsCount}
    </Text>
